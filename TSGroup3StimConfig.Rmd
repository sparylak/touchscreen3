...
dfkeep <- data.frame(date = {}, mouse = {}, correctgrid = {}, samplegrid = {}, correct = {}, incorrect = {})
totalskeep <- data.frame(date = {}, mouse = {}, correctgrid = {}, samplegrid = {}, correcttotal = {}, incorrecttotal = {}, trialcount = {}, percent = {})
```
...
for(fil in filestouse){
    ...
    trackerdf <- data.frame(date = rep(sessiondate,dfrows), mouse = rep(mouseid,dfrows), correctgrid = rep(0,dfrows), samplegrid = 0, correct = 0, incorrect = 0, row.names = (1:dfrows))
    ...
    dftotals <- ddply(trackerdf, .(date, mouse, correctgrid, samplegrid), summarize, correcttotal = sum(correct), incorrecttotal = sum(incorrect))
...
bymouse <- ddply(totalskeep, .(mouse, correctgrid, samplegrid), summarize, totaltrials = sum(trialcount), correct = sum(correcttotal), incorrect = sum(incorrecttotal), meanalldays = (correct/(correct+incorrect)))
bymouse$trialcode <- rep(c("1,2","1,3","2,1","2,3","3,1","3,2"))
