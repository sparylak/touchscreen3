...
for(fil in filestouse){
    ...
    gridid <- 0
    imageid <- 0
    print(paste(currentmouse, currentsched, sep = ","))
...
```{r}
dfkeep$trialblock <- as.factor(cut(dfkeep$totaltrials, breaks = 50*(0:10), include.lowest = TRUE, labels = FALSE))
...
print(g)
###this is nice, but how do I get 1st 50 trials at sample 2, correct 3, etc?
